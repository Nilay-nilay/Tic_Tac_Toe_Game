...
def CheckWinner():
    ...
    if(3 in p1) and (5 in p1) and (7 in p1):
        winner = 1
    if(3 in p2) and (3 in p2) and (7 in p2):
        winner = 2
        if winner ==1:
            messagebox.showinfo(title="greeting",
...
b2.grid(row=1,column=1,sticky="nwse",ipadx=50,ipady=50)
b2.config(command = lambda :  ButtonClick(2))
b3 = ttk.Button(root,text=" ",style="my.TButton")
b3.grid(row=1,column=2,sticky="nwse",ipadx=50,ipady=50)
...
b5.grid(row=2,column=1,sticky="nwse",ipadx=50,ipady=50)
b5.config(command = lambda :  ButtonClick(5))
b6 = ttk.Button(root,text=" ",style="my.TButton")
b6.grid(row=2,column=2,sticky="nwse",ipadx=50,ipady=50)
...
b8.grid(row=3,column=1,sticky="nwse",ipadx=50,ipady=50)
b8.config(command = lambda :  ButtonClick(8))
b9 = ttk.Button(root,text=" ",style="my.TButton")
b9.grid(row=3,column=2,sticky="nwse",ipadx=50,ipady=50)
